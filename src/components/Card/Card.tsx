...
const Card: React.FC<CardProps> = React.memo(({ card, handleCardClick, inspectTouchStart, handleImageLoad }) => {
  ...
  return (
    ...
    >
      <img ref={imgRef} onLoad={handleImageLoad2} src={card.getImageSrc()} alt={card.id.toString()} />
