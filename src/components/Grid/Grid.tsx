...
const Grid: React.FC = () => {
  ...
  const numCols = 4;
  const data = [
    { name: "Alex", image: require(`../../images/1.jpg`) },
    { name: "Jerom", image: require(`../../images/2.jpg`) },
    { name: "John", image: require(`../../images/3.jpg`) },
    { name: "Max", image: require(`../../images/4.jpg`) },
    { name: "Kostya", image: require(`../../images/5.jpg`) },
    { name: "Jay", image: require(`../../images/6.jpg`) },
    { name: "Den", image: require(`../../images/7.jpg`) },
    { name: "Ilya", image: require(`../../images/8.jpg`) },
    { name: "Bella", image: require(`../../images/9.jpg`) },
    { name: "Kate", image: require(`../../images/10.jpg`) },
    { name: "Henry", image: require(`../../images/11.jpg`) },
    { name: "Liza", image: require(`../../images/12.jpg`) },
    { name: "Poli", image: require(`../../images/13.jpg`) },
    { name: "Maria", image: require(`../../images/14.jpg`) },
    { name: "Anna", image: require(`../../images/15.jpg`) },
    { name: "Sam", image: require(`../../images/16.jpg`) }
  ]
  // Initialize cards in a 4x4 grid

  const initialCards = Array.from({ length: numRows * numCols }, (_, index) => {
    ...
    return {
      ...
      getImageSrc: () => require(`../../images/${index + 1}.jpg`),
    }
  });
  ...
  useEffect(() => {
    const loadedImages = data.map(person => {
      return person.image;
    });
  ...
  const inspectTouchStart = (event: React.TouchEvent) => {
    if (!inspectMode) return;
    setIsTouching(true);
